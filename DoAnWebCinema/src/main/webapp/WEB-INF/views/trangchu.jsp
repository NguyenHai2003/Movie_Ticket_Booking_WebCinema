...
const suggestions = {
    notLoggedIn: [
        { text: "Phim <b>Avengers</b> đang hot, bạn có muốn đặt vé ngay không?", tag: "Gợi ý phim hot" },
        { text: "Khám phá những bộ phim mới nhất ngay hôm nay!", tag: "Gợi ý phim hot" },
        { text: "Bạn đã sẵn sàng cho trải nghiệm rạp phim tuyệt vời?", tag: "Gợi ý phim hot" },
    ],
    loggedIn: [
        { text: "Bạn đang phân vân? Tôi sẽ gợi ý cho bạn nhé!", tag: "Gợi ý phim" },
...
function sendMessage(tag) {
    ...
    let message = tag == "Gợi ý phim" ? tag : input.value.trim();
